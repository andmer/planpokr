<script lang="ts">
  // The shared planning-poker explainer rendered on both the unauthenticated
  // landing page and the /about route. Self-contained: keeps its own deck +
  // card-meaning constants and styles, so the host pages just drop it in.
...
<style>
  ...
  .tag-good { color: var(--color-go); background: rgb(45 211 95 / 0.10); border-color: rgb(45 211 95 / 0.25); }
  .tag-warn { color: var(--color-amber); background: rgb(233 184 107 / 0.10); border-color: rgb(233 184 107 / 0.25); }
  .tag-info { color: var(--color-cyan); background: rgb(130 215 255 / 0.08); border-color: rgb(130 215 255 / 0.20); }
  ...
  .fib-points strong { color: var(--color-bright); font-weight: 700; }
  .fib-points em { font-style: italic; color: var(--color-bright); }
  .card-inline {
